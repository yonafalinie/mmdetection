...
class OlnRPNHead(RPNHead):
    ...
    def loss_by_feat(self,
        ...
        num_total_samples = (
            num_total_pos + num_total_neg if getattr(self, 'sampling', True) else num_total_pos)
    ...
    def _get_targets_single(self,
        ...
        assign_result = self.assigner.assign(pred_instances, gt_bboxes,
                                             gt_bboxes_ignore)
        ...
        objectness_assign_result = self.objectness_assigner.assign(
            pred_instances, gt_bboxes, gt_bboxes_ignore)
        objectness_sampling_result = self.objectness_sampler.sample(
            objectness_assign_result, pred_instances, gt_bboxes)
