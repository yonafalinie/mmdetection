...
#SBATCH --job-name=olnssosvitdetltdimagingoodsampling1startepoch3_k_10_ood
#SBATCH -o log/olnssosvitdetltdimagingoodsampling1startepoch3_k_10_ood.out
#SBATCH -t 07-00:00:00
...
K=10
XXXX="vitdet"
AAAA="olnssosvitdetltdimagingoodsampling1startepoch3_k_5_10_threshold_results" 
YYYYY="ltdimaging"
ZZZZZ="oln_ssos_vitdet_box_vit-b-mae_lsj-100e_ltdimaging_oodsampling1_startepoch3"
