...
#SBATCH --job-name=olnssosclipsimplefpnsixray10oodsampling1startepoch3_k100_ood
#SBATCH -o log/olnssosclipsimplefpnsixray10oodsampling1startepoch3_k100_ood.out
#SBATCH -t 07-00:00:00
...
K=100
XXXX="clip"
AAAA="olnssosclipsimplefpnsixray10oodsampling1startepoch3_k5_10_20_25_30_40_50_100_threshold_results" 
YYYYY="sixray10"
ZZZZZ="oln_ssos_clip_simplefpn_sixray10_oodsampling1_startepoch3"
...
for EPOCH in $EPOCHS; do
    ...
    python3 ./tools/test.py "$CONFIG_FILE" "$CKPT" \
        ...
        test_evaluator.optimal_score_threshold=0.00 \
