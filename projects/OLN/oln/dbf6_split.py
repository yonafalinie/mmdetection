...
class DBF6SplitDataset(CocoDataset):
    ...
    def __init__(self, 
                 ...
                 min_size=32,
                 **kwargs):
        print(f"Initializing DBF6SplitDataset with train_class={train_class}, eval_class={eval_class}")
        ...
        super(DBF6SplitDataset, self).__init__(**kwargs)
    
    CLASSES = ('firearm', 'firearmpart', 'knife', 'camera', 'ceramic_knife', 'laptop')
    VOC_CLASSES = (
               'knife', 'camera', 'ceramic_knife', 'laptop')
    NONVOC_CLASSES = (
               'firearm', 'firearmpart')
    class_names_dict = {
        'all': CLASSES,
