dataset_type = 'CityscapesSplitDataset'
data_root = '/home2/projects/datasets/cityscapes/'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
           ann_file=data_root +
            'annotation/instancesonly_filtered_gtFine_train.json',
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root +
        'annotation/instancesonly_filtered_gtFine_val.json',
        img_prefix=data_root ,
        is_class_agnostic=True,
        train_class='id',
        eval_class='id',
    ...
    test=dict(
        type=dataset_type,
        ann_file=data_root +
        'annotation/instancesonly_filtered_gtFine_test.json',
        img_prefix=data_root ,
        is_class_agnostic=True,
        train_class='id',
        eval_class='id',
