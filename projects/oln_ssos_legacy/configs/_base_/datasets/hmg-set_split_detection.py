dataset_type = 'SIXRAYSplitDataset'
data_root = '/home2/projects/datasets/HMG-CAST-firearms-2016-official/FirearmsandCASTbenignPhase1_parcel2/'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'Set_OLN.json',
        img_prefix=data_root + 'Set/',
