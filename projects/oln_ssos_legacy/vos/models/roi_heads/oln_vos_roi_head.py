...
from mmdet.models.roi_heads import OlnRoIHead
...
class OLNKMeansVOSRoIHead(OlnRoIHead):
    ...
    def calculate_pseudo_labels(self):
        ...
        total_samples = np.sum(np.bincount(self.kmeans.labels_))
        cw = total_samples / (self.k * (np.bincount(self.kmeans.labels_)))
