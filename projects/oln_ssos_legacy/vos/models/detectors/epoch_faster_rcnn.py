...
from mmdet.visualization.palette import palette_val
from mmdet.registry import MODELS
from mmdet.models.detectors import FasterRCNN, MaskRCNN

# # Print the registered models
# print("Registered models in MODELS registry:")
...
class EpochFasterRCNN(FasterRCNN):
    ...
    def show_result(self,
        ...
        Returns:
            img (Tensor): Only if not `show` or `out_file`
        """
        return show_result(self.CLASSES,
                           img,
                           result,
                           score_thr,
                           bbox_color,
