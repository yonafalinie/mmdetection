...
load_from = '/home3/qljx17/MMOln-ssos/mmdetection/work_dirs/oln_box_DINOv2_ltdimaging/epoch_32.pth'

# learning rate
param_scheduler = [
    dict(type='LinearLR', start_factor=0.001, by_epoch=False, begin=0, end=500),
    dict(type='CosineAnnealingLR', T_max=18, eta_min=1e-6, by_epoch=True)
]
