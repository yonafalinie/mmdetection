...
backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint='/home3/qljx17/MMOln-ssos/mmdetection/weights/vit-base-p16_sam-pre_3rdparty_sa1b-1024px_20230411-2320f9cc.pth'
             )),
    neck=dict(
        _delete_=True,
        type='SimpleFPN',
...
backend_args = None
dataset_type = 'SSOSSIXRAY10SplitDataset'
train_pipeline = [
...
data_root = '/home2/projects/datasets/SIXRay10/'
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        eval_class='all',
        data_root=data_root,
        data_prefix=dict(img=data_root + 'image/train'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        eval_class='all',
        data_root=data_root,
        data_prefix=dict(img=data_root + 'image/test'),
...
val_evaluator = dict(
    type='PseudoLabelSIXRAY10SplitMetric',
    ann_file=data_root + 'annotation/SIXRay10_test_no_firearm.json',
    train_class='all',
    eval_class='all',
)
...
load_from = '/home3/qljx17/MMOln-ssos/mmdetection/work_dirs/oln_sam_vitb_viasimpleffpn_sixray10/epoch_10.pth'
