...
custom_imports = dict(
    imports=['projects.oln-ssos.oln-ssos', 
             'projects.OLN.oln', 
...
backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint='/home3/qljx17/MMOln-ssos/mmdetection/weights/sam_vit_b_01ec64.pth'
             )),
    neck=dict(
        _delete_=True,
        type='SimpleFPN',
...
backend_args = None
dataset_type = 'SSOSLTDIMAGINGSplitDataset'
train_pipeline = [
...
data_root = '/home2/projects/datasets/CHALearn_LTDImaging/'
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        eval_class='all',
        data_root=data_root,
        ann_file=data_root + 'data/train_week_no_vehicles.json',
        data_prefix=dict(img=data_root + 'data/Week/images'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        eval_class='all',
        data_root=data_root,
        ann_file=data_root + 'data/test_day_no_vehicles.json',
        data_prefix=dict(img=data_root + 'data/Day/images/'),
    ))
...
val_evaluator = dict(
    type='PseudoLabelLTDIMAGINGSplitMetric',
    ann_file=data_root + 'data/test_day_no_vehicles.json',
    train_class='all',
    eval_class='all',
)
...
param_scheduler = [
    ...
    dict(type='MultiStepLR', begin=0, end=18, by_epoch=True, milestones=[6, 7], gamma=0.1)
]

load_from = '/home3/qljx17/MMOln-ssos/mmdetection/work_dirs/oln_sam_vitb_viasimpleffpn_ltdimaging/epoch_16.pth'
