...
custom_imports = dict(
    imports=['projects.oln-ssos.oln-ssos', 'projects.OLN.oln', 'projects.OLN_sam.adapter.sam_vit_adapter'], allow_failed_imports=False)
...
load_from = '/home3/qljx17/MMOln-ssos/mmdetection/work_dirs/oln_sam_vitb_dbf6/epoch_98.pth'
