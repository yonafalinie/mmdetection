...
custom_imports = dict(
    imports=['projects.OLN_pvt.custom',
             'projects.OLN.oln',
             'projects.oln-ssos.oln-ssos'],    
      allow_failed_imports=False)

pretrained='/home3/qljx17/MMOln-ssos/mmdetection/weights/pvt_small.pth'
model = dict(    
    backbone=dict(
        _delete_=True,
        type='pvt_small',
...
load_from = '/home3/qljx17/MMOln-ssos/mmdetection/work_dirs/oln_box_pvt_s_fpn_1x_dbf6/epoch_12.pth'
...
optim_wrapper = dict(
    ...
    optimizer=dict(
        ...
        lr=0.0002,
        weight_decay=0.0001),
     clip_grad=dict(max_norm=35, norm_type=2)  # Add gradient clipping
)
