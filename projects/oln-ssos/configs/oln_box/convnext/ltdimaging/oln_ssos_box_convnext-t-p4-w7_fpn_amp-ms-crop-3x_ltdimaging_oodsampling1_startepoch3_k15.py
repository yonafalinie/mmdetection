...
load_from = '/home3/qljx17/MMOln-ssos/mmdetection/work_dirs/oln_box_convnext-t-p4-w7_fpn_amp-ms-crop-3x_ltdimaging/epoch_36.pth'
# optimizer
# Enable automatic-mixed-precision training with AmpOptimWrapper.
optim_wrapper = dict(
    type='OptimWrapper',  # ← no 'AmpOptimWrapper'
