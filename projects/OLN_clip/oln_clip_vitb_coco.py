...
custom_imports = dict(
    imports=['projects.OLN.oln', 'projects.OLN_clip.adapter.clip_vit_adapter'],
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint='/home/neel/data/Code/MMOln-ssos/mmdetection/weights/vit-base-p32_clip-laion2b-in12k-pre_3rdparty_in1k.pth')),
    neck=dict(
        type='FPN',
...
train_dataloader = dict(
    batch_size=2,  # Adjusted for memory
    dataset=dict(
        type=dataset_type,
